...
// Checks if we support transitions
...
if( !supportsTransitions() ) {
	nwt.anim = function(node, styles, duration, easing) {
		
		for( var i in styles ) console.log(i, ' ' , styles[i])

		console.log(node._node, duration);
		var myFx = new Fx.Morph(node._node, {
